...
namespace PRSv1._0._0.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var appDBContext = _context.Products.Include(p => p.Vendor);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PartNbr,Name,Price,Unit,PhotoPath,VendorId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
